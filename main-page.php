    ...
    <main>
        <section class="section-image section-full-width-right light ken-burn-center" data-parallax="scroll" data-image-src="media/hd-1.jpg">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <h1 data-anima="fade-left" data-time="2000" class="text-lg text-uppercase text-black">Everest Apartments CHS LTD</h1>
                        <hr class="space-lg" />
                    ...
                    <div class="col-lg-6">
                        <ul class="accordion-list" data-open="1">
                            <li>
                                ...
                                <div class="content">
                                    <p>
                                        Nestled in the serene Malabar Hills, our location offers stunning views of lush greenery and majestic peaks. Discover tranquility in the heart of nature, just minutes away from city life.
                        ...
                        <ul class="slider" data-options="type:slider,nav:true,arrows:true,perView:3,perViewLg:2,perViewSm:1,gap:30,controls:out">
                            <li>
                                <a href="treks-single.html" class="media-box media-box-reveal" data-anima="scale" data-trigger="hover">
                                    ...
                                    <div class="caption">
                                        <h2>Bianco</h2>
                                        <div class="extra-field">Contact Now</div>
                                        <h3>Alpes, Italy</h3>
                                        <p>
